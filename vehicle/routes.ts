...
import { carSearchValidate,addVehicleBrandValidate,updateVehicleBrandValidate } from './validators';
...
fastify.put('/update-brand', {preHandler:[adminAuthValidationPreHandler,validation(updateVehicleBrandValidate)]}, handler.updateVehicleTypeHandler);
