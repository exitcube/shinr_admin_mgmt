...
import { createRewardValidate,listRewardValidate,updateRewardValidate } from './validators';
...
export default async function rewardsRoutes(fastify: FastifyInstance, opts: FastifyPluginOptions) {
    ...
    fastify.get('/list-rewards',{ preHandler: [adminAuthValidationPreHandler,validation(listRewardValidate)] },handler.listRewardHandler);
}