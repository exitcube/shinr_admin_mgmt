...
import { listRewardValidate } from './validators';
...
export default async function rewardsRoutes(fastify: FastifyInstance, opts: FastifyPluginOptions) {
    ...
    fastify.post('/create-reward',{preHandler:[adminAuthValidationPreHandler]},handler.createRewardHandler);
    fastify.put('/update-reward' ,{preHandler:[adminAuthValidationPreHandler]},handler.updateRewardHandler);
